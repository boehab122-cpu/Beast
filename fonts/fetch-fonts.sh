...
fetch_one "https://fonts.googleapis.com/css2?family=Public+Sans:wght@400&display=swap" "public-sans-400.woff2"
fetch_one "https://fonts.googleapis.com/css2?family=Public+Sans:wght@500&display=swap" "public-sans-500.woff2"
fetch_one "https://fonts.googleapis.com/css2?family=Public+Sans:wght@600&display=swap" "public-sans-600.woff2"
fetch_one "https://fonts.googleapis.com/css2?family=Public+Sans:wght@700&display=swap" "public-sans-700.woff2"

echo "Fetching Fraunces (opsz 9..144)..."
fetch_one "https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,500&display=swap" "fraunces-500.woff2"
fetch_one "https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,600&display=swap" "fraunces-600.woff2"
fetch_one "https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,700&display=swap" "fraunces-700.woff2"
