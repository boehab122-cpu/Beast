...
echo "Fetching Inter..."
fetch_one "https://fonts.googleapis.com/css2?family=Inter:wght@400&display=swap" "inter-400.woff2"
fetch_one "https://fonts.googleapis.com/css2?family=Inter:wght@500&display=swap" "inter-500.woff2"
fetch_one "https://fonts.googleapis.com/css2?family=Inter:wght@600&display=swap" "inter-600.woff2"
fetch_one "https://fonts.googleapis.com/css2?family=Inter:wght@700&display=swap" "inter-700.woff2"

echo "Fetching Source Serif 4 (opsz 8..60)..."
fetch_one "https://fonts.googleapis.com/css2?family=Source+Serif+4:opsz,wght@8..60,500&display=swap" "source-serif-4-500.woff2"
fetch_one "https://fonts.googleapis.com/css2?family=Source+Serif+4:opsz,wght@8..60,600&display=swap" "source-serif-4-600.woff2"
fetch_one "https://fonts.googleapis.com/css2?family=Source+Serif+4:opsz,wght@8..60,700&display=swap" "source-serif-4-700.woff2"
